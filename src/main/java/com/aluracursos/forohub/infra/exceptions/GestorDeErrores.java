...
public class GestorDeErrores {
    ...
    public ResponseEntity manipularError409(DataIntegrityViolationException ex) {
        var error = new DatosErrorValidacion("Entidad","Ya existe un tópico con el mismotítulo y mensaje");
